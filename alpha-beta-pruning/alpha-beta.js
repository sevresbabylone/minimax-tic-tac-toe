...
function minimax (scoreArray, currentIndex, isMaximisingPlayer) {
  ...
  minimax(scoreArray, leftChildIndex, !isMaximisingPlayer)
  minimax(scoreArray, rightChildIndex, !isMaximisingPlayer)
  var betterIndex
...
console.log(minimax(scoreArray, 0, true))
